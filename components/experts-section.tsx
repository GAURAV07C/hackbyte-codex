  ...
  return (
    <section id="experts" className="py-24 bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 md:mb-8">Meet Our Expert Speakers</h2>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto px-4">
            Learn from industry leaders who are currently shaping the future of technology and business
          </p>
        </motion.div>
                ...
                <CardContent className="p-6 md:p-8 text-center flex flex-col h-full">
                  <div className="relative mb-4 md:mb-6">
                    ...
                    <motion.div
                      ...
                      whileTap={{ scale: 0.9 }}
                    >
                      <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white p-2 md:p-3 rounded-full">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">{expert.name}</h3>
                    <p className="text-base md:text-lg font-semibold text-gray-300 mb-1">{expert.title}</p>
                    <p className="text-blue-400 font-medium mb-3 md:mb-4 text-sm md:text-base">{expert.specialization}</p>
                  ...
                  <div className="mt-auto pt-3 md:pt-4 border-t border-gray-700">
                    <p className="text-xs text-gray-400">{expert.achievements}</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
