...
export function MyWebinars() {
  ...
  const upcomingWebinars = registeredWebinars.filter(
    (w) => w.status === "upcoming"
  );
          ...
          {registeredWebinars.map((webinar, index) => (
            ...
            >
              <Card
                className={`${
                  webinar.status === "live"
                    ? "bg-gradient-to-r from-red-900/20 to-gray-800 border-red-600/30 border-2"
                    : "bg-gray-800"
                } border-gray-700`}
              >
                    ...
                    <div className="flex flex-col justify-center space-y-3">
                      ...
                      <div className="bg-gray-700 rounded-lg p-3 text-center">
                        ...
                        <div className="text-gray-400 text-xs mt-1">
                          {webinar.startDateTime.toLocaleDateString()}
                        </div>
                      </div>
      ...
      {registeredWebinars.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 mb-4">
            You haven&lsquo;t registered for any webinars yet
          </p>
          <Button
