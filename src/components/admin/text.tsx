...
export function WebinarsManagementTab() {
  ...
  const categories = [...new Set(webinars.map((w) => w.category))].filter(
    Boolean
  );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Create, manage, and monitor all webinars
          </p>
        </div>
                      ...
                      <DropdownMenuContent className="bg-gray-800 border-gray-700">
                        ...
                        {webinar.status === "upcoming" && (
                          <DropdownMenuItem
                            ...
                            onClick={() =>
                              handleChangeStatus(webinar.id, "live")
                            }
                          >
                        ...
                        {webinar.status === "live" && (
                          <DropdownMenuItem
                            ...
                            onClick={() =>
                              handleChangeStatus(webinar.id, "completed")
                            }
                          >
